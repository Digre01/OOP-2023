...
public class Food {
	...
	public SortedMap<String,NutritionalElement> rawMaterials = new TreeMap<>();
	...
	public void defineRawMaterial(String name, double calories, double proteins, double carbs, double fat) {
		RawMaterial m = new RawMaterial(name,calories,proteins,carbs,fat);
		rawMaterials.put(name,m);
